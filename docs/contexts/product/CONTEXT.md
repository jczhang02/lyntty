...
- **Surface** — control entry, such as native pi TUI, Android app, or debug web console.
...
- **Sessions Home** — daily entry for recent, running, waiting, failed, and completed sessions.
- **Session Remote** — cockpit for one active session/runtime.
- **Review Evidence** — mode for judging finished or in-progress work from evidence.
- **Node Management / Pairing** — paired computers, QR/code pairing, health, trust, heartbeat, roots, and diagnostics.
- **Settings / Recovery** — relay URL, owner/device binding, revocation, and diagnostics.
