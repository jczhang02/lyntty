...
vi.mock('@/claude/utils/startLynttyServer', () => ({
    startLynttyServer: mockStartLynttyServer,
}));
...
vi.mock('@/claude/utils/generateHookSettings', () => ({
    generateHookSettingsFile: vi.fn(() => '/tmp/lyntty-hook-settings.json'),
...
describe('runClaude remote JSONL scanner', () => {
    ...
    beforeEach(() => {
        ...
        delete process.env.LYNTTY_RECONNECT_SESSION_ID;
        delete process.env.LYNTTY_RECONNECT_ENCRYPTION_KEY;
        delete process.env.LYNTTY_RECONNECT_ENCRYPTION_VARIANT;
        delete process.env.LYNTTY_RECONNECT_SEQ;
        delete process.env.LYNTTY_RECONNECT_METADATA_VERSION;
        delete process.env.LYNTTY_RECONNECT_AGENT_STATE_VERSION;
        delete process.env.LYNTTY_FORKED_FROM_SESSION_ID;
        delete process.env.LYNTTY_FORKED_FROM_MESSAGE_ID;
        delete process.env.LYNTTY_FORK_CLAUDE_SESSION_ID;
        ...
        mockStartLynttyServer.mockResolvedValue({
