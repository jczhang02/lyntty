 ...
 * These messages are forwarded to the Lyntty relay and mobile app.
 */
...
/** Agent identifier */
export type AgentId = 'pi' | 'claude' | 'codex' | 'gemini' | 'opencode' | 'openclaw' | 'claude-acp' | 'codex-acp';
 ...
 * this interface to be usable through the Lyntty CLI and mobile app.
 */
