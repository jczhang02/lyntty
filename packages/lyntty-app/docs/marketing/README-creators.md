# Lyntty Coder Content Creator Brief

## Key Features

Lyntty Coder is an open-source mobile app that lets developers control AI coding agents (Claude Code, Codex, Gemini-CLI) from their phone.
...
- On Lyntty Coder, I can manage Claude Code from my phone without paying $600/year
- On Lyntty Coder, I never miss when Claude gets stuck on a permission prompt
- Lyntty Coder runs on my own computer, not expensive cloud servers
- On Lyntty Coder, I can check on long-running tasks without returning to my desk
- Lyntty Coder is open source - I can audit, modify, or self-host everything
- On Lyntty Coder, I can run multiple agents in parallel and switch between them instantly
- Lyntty Coder keeps my code on my machines with end-to-end encryption
- On Lyntty Coder, I can keep coding while commuting, eating, or away from my desk

## Example Hooks

- "I saved $600/year by switching from [competitor] to the open-source Lyntty Coder"
...
- Clearly say "Lyntty Coder" in the video or caption
- Mention it's free and open source
- Include link to github.com/slopus/lyntty
...
- GitHub: https://github.com/slopus/lyntty
- Website: https://lyntty.engineering
- iOS App: https://apps.apple.com/us/app/lyntty-claude-code-client/id6748571505
- Android App: https://play.google.com/store/apps/details?id=com.ex3ndr.lyntty
- Web App: https://app.lyntty.engineering/