...
export const pt: TranslationStructure = {
    ...
    settings: {
        ...
        audioAssistant: 'Assistente de voz',
        audioAssistantSubtitle: 'Configure as preferências de interação por voz',
        featuresTitle: 'Recursos',
        featuresSubtitle: 'Ativar ou desativar recursos do aplicativo',
        developer: 'Desenvolvedor',
        developerTools: 'Ferramentas de desenvolvedor',
        about: 'Sobre',
        aboutFooter: 'Lyntty é um cliente móvel para pi e pi. É totalmente criptografado ponta a ponta e sua conta é armazenada apenas no seu dispositivo. Não é afiliado à Anthropic.',
        whatsNew: 'Novidades',
        ...
        claudeAuthSuccess: 'Conectado ao pi com sucesso',
    ...
    settingsFeatures: {
        ...
        disableDiagnostics: 'Desativar análises',
        diagnosticsDisabled: 'Todo rastreamento e telemetria desativados',
        diagnosticsEnabled: 'Análises anônimas de uso ativas',
    ...
    errors: {
        ...
        audioSessionFailed: 'Falha ao iniciar sessão de voz',
        audioServiceUnavailable: 'Serviço de voz temporariamente indisponível',
        audioLimitReachedTitle: 'Limite de voz atingido',
        audioHardLimitReached: ({ hours }: { hours: number }) => `Você usou ${hours}+ horas de voz este mês. Este é o máximo permitido. Você pode configurar seu próprio agente ElevenLabs nas configurações de voz para usar sua própria cota.`,
        audioConversationLimitReached: 'Você atingiu o número máximo de conversas de voz este mês. Podemos adicionar uso de voz sob demanda no futuro — por favor, abra um issue em github.com/nicepkg/lyntty/issues se você atingir este limite.',
        ...
        failedToLoadNodes: 'Falha ao carregar lista de amigos',
    ...
    loadingLatestMessages: 'Carregando as mensagens mais recentes…',
        ...
        forkpiOnly: 'A bifurcação atualmente só é suportada para sessões pi.',
    },
    ...
    sessionInfo: {
        ...
        lynttySessionIdCopied: 'ID da sessão Lyntty copiado para a área de transferência',
        failedToCopySessionId: 'Falha ao copiar ID da sessão Lyntty',
        lynttySessionId: 'ID da sessão Lyntty',
        ...
        failedToCopypiCodeSessionId: 'Falha ao copiar ID da sessão pi',
        failedToCopypiThreadId: 'Falha ao copiar ID da thread do pi',
        ...
        updateCliInstructions: 'Por favor execute npm install -g lyntty@latest',
    ...
    settingsAccount: {
        ...
        diagnostics: 'Análises',
        diagnosticsDisabled: 'Nenhum dado é compartilhado',
        diagnosticsEnabled: 'Dados de uso anônimos são compartilhados',
    ...
    machine: {
        ...
        offlineHelp: '• Verifique se seu computador está online\n• Execute `lyntty daemon status` para diagnosticar\n• Você está usando a versão mais recente do CLI? Atualize com `npm install -g lyntty@latest`',
    ...
    claude: {
        ...
        permissions: {
            ...
            noTellpi: 'Não, fornecer feedback',
    ...
    nodes: {
        // Nodes feature
        title: 'Amigos',
        manageNodes: 'Gerencie seus amigos e conexões',
        searchTitle: 'Buscar amigos',
        pendingRequests: 'Solicitações de amizade',
        myNodes: 'Meus amigos',
        noNodesYet: 'Você ainda não tem amigos',
        ...
        requestNodeship: 'Solicitar amizade',
        ...
        nowNodesWith: ({ name }: { name: string }) => `Agora você é amigo de ${name}`,
    },
