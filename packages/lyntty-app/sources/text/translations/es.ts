...
export const es: TranslationStructure = {
    ...
    settings: {
        ...
        audioAssistant: 'Asistente de voz',
        audioAssistantSubtitle: 'Configura las preferencias de voz',
        ...
        about: 'Acerca de',
        aboutFooter: 'Lyntty es un cliente móvil para pi y pi. Todo está cifrado de extremo a extremo y tu cuenta se guarda solo en tu dispositivo. No está afiliado con Anthropic.',
        whatsNew: 'Novedades',
        ...
        claudeAuthSuccess: 'Conectado exitosamente con pi',
    ...
    settingsFeatures: {
        ...
        disableDiagnostics: 'Desactivar analítica',
        diagnosticsDisabled: 'Todo el seguimiento y telemetría desactivados',
        diagnosticsEnabled: 'Analítica anónima de uso activa',
    ...
    errors: {
        ...
        audioSessionFailed: 'Falló al iniciar sesión de voz',
        audioServiceUnavailable: 'El servicio de voz no está disponible temporalmente',
        audioLimitReachedTitle: 'Límite de voz alcanzado',
        audioHardLimitReached: ({ hours }: { hours: number }) => `Has usado ${hours}+ horas de voz este mes. Este es el máximo permitido. Puedes configurar tu propio agente ElevenLabs en la configuración de voz para usar tu propia cuota.`,
        audioConversationLimitReached: 'Has alcanzado el número máximo de conversaciones de voz este mes. Es posible que en el futuro agreguemos uso de voz bajo demanda — por favor crea un issue en github.com/nicepkg/lyntty/issues si alcanzas este límite.',
        ...
        failedToLoadNodes: 'No se pudo cargar la lista de amigos',
    ...
    loadingLatestMessages: 'Cargando los mensajes más recientes…',
        ...
        forkpiOnly: 'La bifurcación actualmente solo se admite para sesiones de pi.',
    },
    ...
    sessionInfo: {
        ...
        lynttySessionIdCopied: 'ID de sesión de Lyntty copiado al portapapeles',
        failedToCopySessionId: 'Falló al copiar ID de sesión de Lyntty',
        lynttySessionId: 'ID de sesión de Lyntty',
        ...
        failedToCopypiCodeSessionId: 'Falló al copiar ID de sesión de pi',
        failedToCopypiThreadId: 'Falló al copiar ID del hilo de pi',
        ...
        updateCliInstructions: 'Por favor ejecute npm install -g lyntty@latest',
    ...
    settingsAccount: {
        ...
        diagnostics: 'Analíticas',
        diagnosticsDisabled: 'No se comparten datos',
        diagnosticsEnabled: 'Se comparten datos de uso anónimos',
    ...
    welcome: {
        ...
        title: 'Cliente móvil de pi y pi',
    ...
    machine: {
        ...
        offlineHelp: '• Asegúrate de que tu computadora esté en línea\n• Ejecuta `lyntty daemon status` para diagnosticar\n• ¿Estás usando la última versión del CLI? Actualiza con `npm install -g lyntty@latest`',
    ...
    claude: {
        ...
        permissions: {
            ...
            noTellpi: 'No, proporcionar comentarios',
    ...
    nodes: {
        // Nodes feature
        title: 'Amigos',
        manageNodes: 'Administra tus amigos y conexiones',
        searchTitle: 'Buscar amigos',
        pendingRequests: 'Solicitudes de amistad',
        myNodes: 'Mis amigos',
        noNodesYet: 'Aún no tienes amigos',
        findNodes: 'Buscar amigos',
        remove: 'Eliminar',
        ...
        requestNodeship: 'Solicitar amistad',
        ...
        nowNodesWith: ({ name }: { name: string }) => `Ahora eres amigo de ${name}`,
    },
