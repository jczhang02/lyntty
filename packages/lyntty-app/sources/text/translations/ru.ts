...
export const ru: TranslationStructure = {
    ...
    settings: {
        ...
        audioAssistant: 'Голосовой ассистент',
        audioAssistantSubtitle: 'Настройка предпочтений голосового взаимодействия',
        featuresTitle: 'Возможности',
        featuresSubtitle: 'Включить или отключить функции приложения',
        developer: 'Разработчик',
        developerTools: 'Инструменты разработчика',
        about: 'О программе',
        aboutFooter: 'Lyntty — мобильное приложение для работы с pi и pi. Использует сквозное шифрование, все данные аккаунта хранятся только на вашем устройстве. Не связано с Anthropic.',
        whatsNew: 'Что нового',
        ...
        claudeAuthSuccess: 'Успешно подключено к pi',
    ...
    settingsFeatures: {
        ...
        disableDiagnostics: 'Отключить аналитику',
        diagnosticsDisabled: 'Вся аналитика и телеметрия отключены',
        diagnosticsEnabled: 'Анонимная аналитика использования активна',
    ...
    errors: {
        ...
        audioSessionFailed: 'Не удалось запустить голосовую сессию',
        audioServiceUnavailable: 'Голосовой сервис временно недоступен',
        audioLimitReachedTitle: 'Лимит голоса достигнут',
        audioHardLimitReached: ({ hours }: { hours: number }) => `Вы использовали ${hours}+ часов голосового общения в этом месяце. Это максимально допустимый лимит. Вы можете настроить собственного агента ElevenLabs в настройках голоса, чтобы использовать свою квоту.`,
        audioConversationLimitReached: 'Вы достигли максимального количества голосовых разговоров в этом месяце. Возможно, в будущем мы добавим голосовое использование по запросу — пожалуйста, создайте заявку на github.com/nicepkg/lyntty/issues, если вы столкнулись с этим ограничением.',
        ...
        failedToLoadNodes: 'Не удалось загрузить список друзей',
    ...
    sessionInfo: {
        ...
        failedToCopySessionId: 'Не удалось скопировать ID сессии Lyntty',
        lynttySessionId: 'ID сессии Lyntty',
        ...
        failedToCopypiCodeSessionId: 'Не удалось скопировать ID сессии pi',
        failedToCopypiThreadId: 'Не удалось скопировать ID треда pi',
        ...
        updateCliInstructions: 'Пожалуйста, выполните npm install -g lyntty@latest',
    ...
    loadingLatestMessages: 'Загрузка последних сообщений…',
        ...
        forkpiOnly: 'Форк сейчас поддерживается только для pi-сессий.',
    },
    ...
    settingsAccount: {
        ...
        diagnostics: 'Аналитика',
        diagnosticsDisabled: 'Данные не передаются',
        diagnosticsEnabled: 'Анонимные данные об использовании передаются',
    ...
    welcome: {
        ...
        title: 'Мобильный клиент pi и pi',
    ...
    machine: {
        ...
        offlineHelp: '• Убедитесь, что компьютер online\n• Выполните `lyntty daemon status` для диагностики\n• Используете последнюю версию CLI? Обновите командой `npm install -g lyntty@latest`',
    ...
    claude: {
        ...
        permissions: {
            ...
            noTellpi: 'Нет, дать обратную связь',
    ...
    nodes: {
        // Nodes feature
        title: 'Друзья',
        manageNodes: 'Управляйте своими друзьями и связями',
        searchTitle: 'Найти друзей',
        pendingRequests: 'Запросы в друзья',
        myNodes: 'Мои друзья',
        noNodesYet: 'У вас пока нет друзей',
        findNodes: 'Найти друзей',
        remove: 'Удалить',
        ...
        requestNodeship: 'Отправить запрос в друзья',
        ...
        nowNodesWith: ({ name }: { name: string }) => `Теперь вы друзья с ${name}`,
    },
