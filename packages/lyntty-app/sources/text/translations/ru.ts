...
export const ru: TranslationStructure = {
    ...
    server: {
        ...
        previewSetupTitle: 'Подключение к Relay',
        previewSetupDescription: 'Перед созданием или восстановлением аккаунта Lyntty (preview) необходимо подключить к локальному Relay.',
