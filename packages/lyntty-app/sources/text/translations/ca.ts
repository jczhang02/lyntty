...
export const ca: TranslationStructure = {
    ...
    settings: {
        ...
        audioAssistant: 'Assistent de veu',
        audioAssistantSubtitle: 'Configura les preferències d\'interacció per veu',
        ...
        about: 'Quant a',
        aboutFooter: 'Lyntty és un client mòbil de pi i pi. Tot està xifrat punt a punt i el teu compte es guarda només al teu dispositiu. No està afiliat amb Anthropic.',
        whatsNew: 'Novetats',
        ...
        claudeAuthSuccess: 'Connexió amb pi realitzada amb èxit',
    ...
    settingsFeatures: {
        ...
        diagnosticsDisabled: 'Tot el seguiment i telemetria desactivats',
        diagnosticsEnabled: 'Analítica anònima d\'ús activa',
    ...
    errors: {
        ...
        audioSessionFailed: 'Ha fallat l\'inici de la sessió de veu',
        audioServiceUnavailable: 'El servei de veu no està disponible temporalment',
        audioLimitReachedTitle: 'Límit de veu assolit',
        audioHardLimitReached: ({ hours }: { hours: number }) => `Has utilitzat ${hours}+ hores de veu aquest mes. Aquest és el màxim permès. Pots configurar el teu propi agent ElevenLabs a la configuració de veu per utilitzar la teva pròpia quota.`,
        audioConversationLimitReached: 'Has assolit el nombre màxim de converses de veu aquest mes. És possible que en el futur afegim ús de veu sota demanda — si us plau, crea un issue a github.com/nicepkg/lyntty/issues si arribes a aquest límit.',
        ...
        failedToLoadNodes: 'No s\'ha pogut carregar la llista d\'amics',
    ...
    loadingLatestMessages: 'Carregant els darrers missatges…',
        ...
        forkpiOnly: 'La bifurcació només està disponible per a sessions de pi.',
    },
    ...
    sessionInfo: {
        ...
        lynttySessionIdCopied: 'ID de la sessió de Lyntty copiat al porta-retalls',
        failedToCopySessionId: 'Ha fallat copiar l\'ID de la sessió de Lyntty',
        lynttySessionId: 'ID de la sessió de Lyntty',
        ...
        failedToCopypiCodeSessionId: 'Ha fallat copiar l\'ID de la sessió de pi',
        failedToCopypiThreadId: 'Ha fallat copiar l\'ID del fil de pi',
        ...
        updateCliInstructions: 'Si us plau executeu npm install -g lyntty@latest',
    ...
    settingsAccount: {
        ...
        diagnostics: 'Analítiques',
        diagnosticsDisabled: 'No es comparteixen dades',
        diagnosticsEnabled: 'Es comparteixen dades d\'ús anònimes',
    ...
    machine: {
        ...
        offlineHelp: '• Assegura\'t que l\'ordinador estigui en línia\n• Executa `lyntty daemon status` per diagnosticar\n• Fas servir l\'última versió del CLI? Actualitza amb `npm install -g lyntty@latest`',
    ...
    claude: {
        ...
        permissions: {
            ...
            noTellpi: 'No, proporciona comentaris',
    ...
    nodes: {
        // Nodes feature
        title: 'Amics',
        manageNodes: 'Gestiona els teus amics i connexions',
        searchTitle: 'Buscar amics',
        pendingRequests: 'Sol·licituds d\'amistat',
        myNodes: 'Els meus amics',
        noNodesYet: 'Encara no tens amics',
        findNodes: 'Buscar amics',
        remove: 'Eliminar',
        ...
        requestNodeship: 'Sol·licitar amistat',
        ...
        nowNodesWith: ({ name }: { name: string }) => `Ara ets amic de ${name}`,
    },
