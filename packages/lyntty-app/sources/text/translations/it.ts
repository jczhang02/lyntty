...
export const it: TranslationStructure = {
    ...
    settings: {
        ...
        audioAssistant: 'Assistente vocale',
        audioAssistantSubtitle: 'Configura le preferenze vocali',
        ...
        about: 'Informazioni',
        aboutFooter: 'Lyntty è un client mobile per pi e pi. È completamente cifrato end-to-end e il tuo account è memorizzato solo sul tuo dispositivo. Non affiliato con Anthropic.',
        whatsNew: 'Novità',
        ...
        claudeAuthSuccess: 'Connesso a pi con successo',
    ...
    settingsFeatures: {
        ...
        disableDiagnostics: 'Disabilita analisi',
        diagnosticsDisabled: 'Tutto il tracciamento e la telemetria disabilitati',
        diagnosticsEnabled: 'Analisi anonime di utilizzo attive',
    ...
    errors: {
        ...
        audioSessionFailed: 'Avvio della sessione vocale non riuscito',
        audioServiceUnavailable: 'Il servizio vocale non è temporaneamente disponibile',
        audioLimitReachedTitle: 'Limite vocale raggiunto',
        audioHardLimitReached: ({ hours }: { hours: number }) => `Hai utilizzato ${hours}+ ore di voce questo mese. Questo è il massimo consentito. Puoi configurare il tuo agente ElevenLabs nelle impostazioni vocali per utilizzare la tua quota.`,
        audioConversationLimitReached: 'Hai raggiunto il numero massimo di conversazioni vocali questo mese. Potremmo aggiungere l\'uso vocale su richiesta in futuro — per favore apri un issue su github.com/nicepkg/lyntty/issues se raggiungi questo limite.',
        ...
        failedToLoadNodes: 'Impossibile caricare la lista amici',
    ...
    loadingLatestMessages: 'Caricamento degli ultimi messaggi…',
        ...
        forkpiOnly: 'La biforcazione è attualmente supportata solo per le sessioni pi.',
    },
    ...
    sessionInfo: {
        ...
        failedToCopySessionId: 'Impossibile copiare l\'ID sessione Lyntty',
        lynttySessionId: 'ID sessione Lyntty',
        ...
        failedToCopypiCodeSessionId: 'Impossibile copiare l\'ID sessione pi',
        failedToCopypiThreadId: 'Impossibile copiare l\'ID thread pi',
        ...
        updateCliInstructions: 'Esegui npm install -g lyntty@latest',
    ...
    agentInput: {
        ...
        codexModel: {
            title: 'MODELLO CODEX',
            gpt5piLow: 'gpt-5-codex basso',
            gpt5piMedium: 'gpt-5-codex medio',
            gpt5piHigh: 'gpt-5-codex alto',
    ...
    settingsAccount: {
        ...
        diagnosticsDisabled: 'Nessun dato condiviso',
        diagnosticsEnabled: 'I dati di utilizzo anonimi sono condivisi',
    ...
    welcome: {
        ...
        title: 'Client mobile di pi e pi',
    ...
    machine: {
        ...
        offlineHelp: '• Assicurati che il tuo computer sia online\n• Esegui `lyntty daemon status` per diagnosticare\n• Stai usando l\'ultima versione della CLI? Aggiorna con `npm install -g lyntty@latest`',
        daemon: 'Daemon',
        status: 'Stato',
    ...
    nodes: {
        // Nodes feature
        title: 'Amici',
        manageNodes: 'Gestisci i tuoi amici e le connessioni',
        searchTitle: 'Trova amici',
        pendingRequests: 'Richieste di amicizia',
        myNodes: 'I miei amici',
        noNodesYet: 'Non hai ancora amici',
        findNodes: 'Trova amici',
        remove: 'Rimuovi',
        ...
        requestNodeship: 'Richiedi amicizia',
        ...
        nowNodesWith: ({ name }: { name: string }) => `Ora sei amico di ${name}`,
    },
