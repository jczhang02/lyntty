...
export const en: TranslationStructure = {
    ...
    settings: {
        ...
        audioAssistantSubtitle: 'Configure audio interaction preferences',
        featuresTitle: 'Features',
        featuresSubtitle: 'Enable or disable app features',
        developer: 'Developer',
        developerTools: 'Developer Tools',
        about: 'About',
        aboutFooter: 'Lyntty is a pi and pi mobile client. It\'s fully end-to-end encrypted and your account is stored only on your device. Not affiliated with Anthropic.',
        whatsNew: 'What\'s New',
        ...
        claudeAuthSuccess: 'Successfully connected to pi',
    ...
    errors: {
        ...
        audioHardLimitReached: ({ hours }: { hours: number }) => `You've used ${hours}+ hours of audio this month. This is the maximum allowed. You can configure your own ElevenLabs agent in Audio settings to use your own quota.`,
        audioConversationLimitReached: 'You\'ve reached the maximum number of audio conversations this month. We may add on-demand audio usage in the future — please file an issue at github.com/nicepkg/lyntty/issues if you hit this limit.',
...
stopAndArchiveSession: 'Stop & Archive',
        ...
        failedToCopypiCodeSessionId: 'Failed to copy pi Session ID',
        failedToCopypiThreadId: 'Failed to copy pi Thread ID',
