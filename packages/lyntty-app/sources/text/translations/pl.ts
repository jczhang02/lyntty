...
export const pl: TranslationStructure = {
    ...
    settings: {
        ...
        audioAssistant: 'Asystent głosowy',
        audioAssistantSubtitle: 'Konfiguruj preferencje interakcji głosowej',
        featuresTitle: 'Funkcje',
        featuresSubtitle: 'Włącz lub wyłącz funkcje aplikacji',
        developer: 'Deweloper',
        developerTools: 'Narzędzia deweloperskie',
        about: 'O aplikacji',
        aboutFooter: 'Lyntty to mobilny klient pi i pi. Jest w pełni szyfrowany end-to-end, a Twoje konto jest przechowywane tylko na Twoim urządzeniu. Nie jest powiązany z Anthropic.',
        whatsNew: 'Co nowego',
        ...
        claudeAuthSuccess: 'Pomyślnie połączono z pi',
    ...
    settingsFeatures: {
        ...
        disableDiagnostics: 'Wyłącz analitykę',
        diagnosticsDisabled: 'Wszystkie śledzenie i telemetria wyłączone',
        diagnosticsEnabled: 'Anonimowa analityka użytkowania aktywna',
    ...
    errors: {
        ...
        audioSessionFailed: 'Nie udało się uruchomić sesji głosowej',
        audioServiceUnavailable: 'Usługa głosowa jest tymczasowo niedostępna',
        audioLimitReachedTitle: 'Osiągnięto limit głosu',
        audioHardLimitReached: ({ hours }: { hours: number }) => `Wykorzystałeś ${hours}+ godzin głosu w tym miesiącu. To jest maksymalny dozwolony limit. Możesz skonfigurować własnego agenta ElevenLabs w ustawieniach głosu, aby korzystać z własnego limitu.`,
        audioConversationLimitReached: 'Osiągnąłeś maksymalną liczbę rozmów głosowych w tym miesiącu. Możliwe, że w przyszłości dodamy głosowe korzystanie na żądanie — prosimy o zgłoszenie na github.com/nicepkg/lyntty/issues, jeśli napotkasz ten limit.',
        ...
        failedToLoadNodes: 'Nie udało się załadować listy przyjaciół',
    ...
    loadingLatestMessages: 'Ładowanie najnowszych wiadomości…',
        ...
        forkpiOnly: 'Rozwidlenie jest obecnie obsługiwane tylko dla sesji pi.',
    },
    ...
    sessionInfo: {
        ...
        lynttySessionIdCopied: 'ID sesji Lyntty skopiowane do schowka',
        failedToCopySessionId: 'Nie udało się skopiować ID sesji Lyntty',
        lynttySessionId: 'ID sesji Lyntty',
        ...
        failedToCopypiCodeSessionId: 'Nie udało się skopiować ID sesji pi',
        failedToCopypiThreadId: 'Nie udało się skopiować ID wątku pi',
        ...
        updateCliInstructions: 'Proszę uruchomić npm install -g lyntty@latest',
    ...
    settingsAccount: {
        ...
        diagnostics: 'Analityka',
        diagnosticsDisabled: 'Dane nie są udostępniane',
        diagnosticsEnabled: 'Anonimowe dane o użytkowaniu są udostępniane',
    ...
    machine: {
        ...
        offlineHelp: '• Upewnij się, że komputer jest online\n• Uruchom `lyntty daemon status`, aby zdiagnozować\n• Czy używasz najnowszej wersji CLI? Zaktualizuj poleceniem `npm install -g lyntty@latest`',
    ...
    nodes: {
        // Nodes feature
        title: 'Przyjaciele',
        manageNodes: 'Zarządzaj swoimi przyjaciółmi i połączeniami',
        searchTitle: 'Znajdź przyjaciół',
        pendingRequests: 'Zaproszenia do znajomych',
        myNodes: 'Moi przyjaciele',
        noNodesYet: 'Nie masz jeszcze żadnych przyjaciół',
        findNodes: 'Znajdź przyjaciół',
        remove: 'Usuń',
        ...
        alreadyNodes: 'Już jesteście znajomymi',
        ...
        requestNodeship: 'Wyślij zaproszenie do znajomych',
        ...
        nowNodesWith: ({ name }: { name: string }) => `Teraz jesteś w gronie znajomych z ${name}`,
    },
