    ...
    const testVectors = [
        {
            ...
            usage: 'test usage',
            path: ['child1', 'child2'],
            expectedRootKey: hex('E6E55652456F9FE4', '7D6FF46CA3614E85', 'B499F77E7B340FBB', 'B1553307CEDC1E74'),
            expectedRootChainCode: hex('81ECFD529E8EF95D', 'D5C06CFE169158CF', '02B7C09A33746C52', '7B4BD4D740B9CC5A'),
            expectedChildKey: hex('D5EAE039FB9143E9', '433BB1ADC104C2FF', '5D7FA6751E680B4B', '1CBC7ADF1AF65BF3'),
            expectedChildChainCode: hex('8AA339189BAB38B5', '1DD8770B1498682B', 'CB03E42240E27304', '1ACC7E3DF62FE868'),
            expectedFinalKey: hex('1011C097D2105D27', '362B987A631496BB', 'F68B836124D1D072', 'E9D1613C6028CF75'),
            expectedFinalChainCode: hex('BE98EF894B1C62B8', '253B480DD415B6EB', '707028362F2FCECF', '2CB3871DB8B007F1')
        }
    ];
