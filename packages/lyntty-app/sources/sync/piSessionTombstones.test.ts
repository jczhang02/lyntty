...
describe('Pi session tombstone persistence', () => {
    ...
    it('deduplicates by relay id or Pi identity without crossing accounts', () => {
        const current = [
            { serverId: 'account-a', relaySessionId: 'relay-old', machineId: 'machine-a', piSessionId: 'pi-a', deletedAt: 1 },
        ...
        expect(next).toEqual([
            { serverId: 'account-a', relaySessionId: 'relay-new', machineId: 'machine-a', piSessionId: 'pi-a', deletedAt: 3 },
            { serverId: 'account-b', relaySessionId: 'relay-b', machineId: 'machine-a', piSessionId: 'pi-a', deletedAt: 2 },
        ]);
    });
});
